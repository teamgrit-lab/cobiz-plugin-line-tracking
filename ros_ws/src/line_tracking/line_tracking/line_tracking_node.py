...
class LineTrackingNode(Node):
    ...
    def _declare_parameters(self) -> None:
        parameters = {
            ...
            "lab_b_min": 110,
            "adaptive_lab_percentile": 0.0,
            "red_blue_min": -8,
            "red_green_min": 25,
            "warm_luminance_min": 145,
            "prefer_warm_camera_mask": True,
            ...
            "open_kernel": 3,
            "close_kernel": 7,
            "line_close_kernel": 31,
            "min_component_area_px": 80,
            "line_min_area_px": 250,
            "line_min_span_px": 40,
            "line_feature_enabled": True,
            "line_min_elongation": 2.0,
            "line_roi_polygon": [
                0.10,
                1.00,
                0.90,
    ...
    def _vision_config(self) -> VisionConfig:
        ...
        return VisionConfig(
            ...
            red_blue_min=int(value("red_blue_min")),
            red_green_min=int(value("red_green_min")),
            warm_luminance_min=int(value("warm_luminance_min")),
            prefer_warm_camera_mask=bool(value("prefer_warm_camera_mask")),
            ...
            line_close_kernel=int(value("line_close_kernel")),
            min_component_area_px=int(value("min_component_area_px")),
            line_min_area_px=int(value("line_min_area_px")),
            line_min_span_px=int(value("line_min_span_px")),
            line_feature_enabled=bool(value("line_feature_enabled")),
            line_min_elongation=float(value("line_min_elongation")),
            line_roi_polygon=_as_tuple(value("line_roi_polygon"), float),
    ...
    def _build_debug_frame(self, frame: Any, result: VisionResult) -> Any:
        ...
        if result.line_roi_polygon_px is not None:
            cv2.polylines(
                debug,
                [result.line_roi_polygon_px],
                True,
                (255, 255, 255),
                2,
            )
